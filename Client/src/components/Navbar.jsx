      ...
      <nav className=" mx-auto w-full flex justify-between items-center sticky top-5">
        ...
        >
          ...
          {token ? (
            <button
              onClick={logOut}
              className="bg-lime-300 px-5 py-1 rounded-md lg:rounded-xl shadow-lg text-[#7d0000] text-sm"
            >
              Log Out
            </button>
          ) : (
        ...
        >
          ...
          {token ? (
            <button
              onClick={logOut}
              className="bg-lime-300 px-5 py-1 rounded-md lg:rounded-xl shadow-lg text-[#7d0000] text-sm hover:animate-pulse"
            >
              Log Out
            </button>
          ) : (
            <>
              <Link
                to={"/login"}
                className="bg-lime-300 px-5 py-1 rounded-md lg:rounded-xl shadow-lg text-[#7d0000] text-sm hover:animate-bounce"
              >
                Log In
              </Link>
              <Link
